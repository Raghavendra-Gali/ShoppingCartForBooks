       ...
       console.log("Getting data for url",urlbookCount);
        ...
        getBook.onreadystatechange = function(){
          //if(this.readystate == 4 && this.status == 200){
            ...
            // console.log("length "+bookCount.length);
            // console.log(bookCount.bookId[i])
            // var key = "";
            // var s = bookCount.split(":");



            // console.log(s+"Along with index "+s[1]);
            // console.log(l);
            // for(key in bookCount){
            //     console.log(bookCount[key]);
            // }
            console.log("Printing: ",bookCount[bookId[i]]);
            // var s = "" + ;
            // console.log(s);
...
function updateCart(){
 ...
 //if(numBooks.readystate == 4 && numBooks.status == 200){
    ...
    cart = JSON.parse(JSON.stringify(numBooks.responseText))
    console.log(cart);
